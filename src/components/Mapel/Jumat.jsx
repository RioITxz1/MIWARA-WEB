	...
	return (
		<>
			<div
				...
				<div className="flex justify-center items-center text-sm">Ratu</div>
			</div>
			<div
				...
				<div className="flex justify-center items-center text-sm">Suko</div>
			</div>
			<div
				className="border-t-2 border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3"
				data-aos="fade-up"
				...
				<div className="flex justify-center items-center text-sm">Bude</div>
			</div>
		</>
	)
}
