	...
	return (
		<>
			<div
				...
				<div className="flex justify-center items-center text-sm">Donna</div>
			</div>
			<div
				...
				<div className="flex justify-center items-center text-sm">Ayah Hassan</div>
			</div>
			<div
				className="border-t-2 border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3"
				data-aos="fade-up"
				...
				<div className="flex justify-center items-center text-sm">Budi</div>
			</div>
			<div
				...
				<div className="flex justify-center items-center text-sm">Eko</div>
			</div>
			<div
				className=" border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3"
				data-aos="fade-up"
				...
				<div className="flex justify-center items-center text-sm">Japili</div>
			</div>
		</>
	)
}
